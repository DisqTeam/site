...
export default function privacy() {
  return (
    <div className="legal_container">
      ...
      <p>
        Your privacy is important to us. It is Stringy Software&#39;s policy to
        ...
        across our website, <a href="https://disq.me">https://disq.me</a>, and
        other sites we own and operate.{" "}
      </p>
      <p>
        This policy is effective as of 2nd March 2021 and was last updated on 2nd March 2021.{" "}
      </p>
      ...
      <p>
        ...
        standard data provided by your web browser.<br/> This may include: {" "}
      </p>
      <ul>
        <li>Your device’s IP address</li>
        <li>Your browser type and version</li>
        <li>The time and date of your visit</li>
        <li>Technical details that occur in conjunction with any errors you may encounter.</li>
      </ul>
      ...
      <p>
        ...
        the age of 13, and it is not our intention to collect personal information
